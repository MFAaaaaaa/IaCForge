...
ARTIFACTS = [
    ...
    Artifact("kg_repair", "paperkg/both_localrepair1_no_direct_kg", "qwen2.5-coder-14b", result("qwen2.5-coder-14b", "FullKGVeriGraph-paperrepjson-both-faithfulgraph-simplegraphir-promptschema-localrepair1-promptonly-full458-v1-32k-maxtok16384-20260803"), "logs/qwen25coder14b-paperrepjson-both-faithfulgraph-simplegraphir-promptschema-localrepair1-promptonly-full458-v1-32k-maxtok16384-20260803.log", required=False),
